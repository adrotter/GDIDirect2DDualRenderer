...
#End Region
    ...
    Public Overrides Sub FillRectangle(brush As Drawing.Brush, rect As Rectangle)
        ...
        ' we must change the color here because the 'If Not _hasBegunDrawing' test above recreates the RT
        _targets(_selectedTargetIdx).Clear(DrawingColorToD2DColor(Color.Yellow))
